...
const oksController = <IControllers> {};


oksController.find = async(req,res,next)=>{
  try{
       ...
       const query = req.query;
        ...
        let totalResult = oks.countDocuments(query);
        const total = oks.countDocuments(query);
        let question = oks.find(query);
...
oksController.findOne = async (req,res,next)=>{
    try{
...
oksController.create = async (req,res,next) => {
    try{

        const data  = req.body;
   
   const resp = await oks.create(data)
        res.ok(resp);
...
oksController.update = async (req,res,next)=>{
    ...
    try{
      ...
      const resp = await  oks.updateMany(query,data)
            res.ok(resp);
...
oksController.updateOne = async (req,res,next)=>{
    try{
   ...
   const resp = await oks.findByIdAndUpdate(id,data)
   if(!resp){
    next();
}else{
    res.ok(resp);
...
oksController.deleteOne = async (req,res,next)=>{
    try{
   ...
   const resp = await oks.deleteOne(id)
